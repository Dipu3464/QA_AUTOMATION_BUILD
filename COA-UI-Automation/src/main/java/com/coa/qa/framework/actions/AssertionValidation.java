...
public class AssertionValidation {
     ...
     */
    public void checkTitle(String title) throws FailedTestCases {
     ...
     */
    public void checkPartialTitle(String partialTitle) throws FailedTestCases {
        String pageTitle = getPageTitle();
...
//				scenario.write("Actual Value '"+ elementText +"' Doesn't matches with Expected value '"+expectedValue+"'");
     ...
     * @param selector     : String : Locator value
     */
    public void checkElementPartialText(String selectorType, String actualValue, String selector) throws FailedTestCases {
        String elementText = getElementText(selectorType, selector);
     ...
     * @param selector     : String : Locator value
     */
    public void checkElementEnable(String selectorType, String selector) throws FailedTestCases {
    ...
    public boolean checkElementPresence(WebElement el,String selectorType,String selector) {
        boolean bool;
        try {
            el.findElement(selectTypeObj.getelementbytype(selectorType, selector));
            bool = true;
        } catch (NoSuchElementException e) {
            bool = false;
        }
